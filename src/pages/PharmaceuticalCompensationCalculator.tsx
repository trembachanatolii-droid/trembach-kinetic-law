            ...
            {step === 3 && results && (
              <div className="space-y-8">
                ...
                <div className="calculator-cta-section">
                  <h3 className="text-2xl font-bold mb-4">Hold Pharmaceutical Companies Accountable</h3>
                  <p className="mb-6 max-w-2xl mx-auto">
                    Dangerous drug cases require expert medical testimony and deep knowledge of FDA regulations. 
                    Our attorneys handle pharmaceutical litigation nationwide. No fee unless we win.
                  </p>
