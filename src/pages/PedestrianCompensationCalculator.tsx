          ...
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-slate-600">Severe injury average</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-slate-900 mb-2">Priority</div>
                <p className="text-slate-600">Pedestrian right-of-way</p>
              </div>
              <div>
