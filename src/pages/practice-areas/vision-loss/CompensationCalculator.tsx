...
import { Calculator, ArrowLeft, Eye } from 'lucide-react';

const VisionLossCompensationCalculator = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Vision Loss Calculator | Blindness Compensation | Trembach Law</title>
        <meta name="description" content="Calculate vision loss compensation for eye injuries and blindness. Free one-eye and total blindness estimates." />
      </Helmet>
          ...
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-slate-600">Total blindness average</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-slate-900 mb-2">Lifetime</div>
                <p className="text-slate-600">Vision assistance coverage</p>
              </div>
              <div>
