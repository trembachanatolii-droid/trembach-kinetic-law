...
import poolSafetyEquipmentImage from '@/assets/swimming-pool-safety-equipment.jpg';
import poolProfessionalImage from '@/assets/swimming-pool-professional.jpg';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="relative z-10 p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <Button 
                      size="lg" 
                      className="w-full bg-white/10 backdrop-blur-sm border border-white/30 text-white hover:bg-white/20 transition-colors"
          ...
          <div className="lg:col-span-2 lg:order-1" ref={contentRef}>
            ...
            <section id="immediate-steps" className="content-section mb-12">
              ...
              <div className="mb-8">
                <img 
                  src={poolProfessionalImage} 
                  alt="Professional Swimming Pool" 
