...
import { Calculator, ArrowLeft, Car } from 'lucide-react';
...
const UberLyftCompensationCalculator = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Uber Lyft Calculator | Rideshare Accident Compensation | Trembach Law</title>
        <meta name="description" content="Calculate Uber Lyft compensation for rideshare accidents. Free passenger and driver injury estimates." />
      </Helmet>
          ...
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-slate-600">Passenger injury average</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-slate-900 mb-2">$1M</div>
                <p className="text-slate-600">Policy coverage</p>
              </div>
              <div>
