              ...
              <div className="relative z-10 text-center px-6 py-32 max-w-5xl mx-auto">
                ...
                <div className="flex gap-3 justify-center flex-wrap">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0071E3] hover:bg-[#0066CC] active:bg-[#0057A3] text-white rounded-full text-sm font-medium transition-all duration-200"
                  >
