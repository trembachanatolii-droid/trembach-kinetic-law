            ...
            {step === 3 && results && (
              <div className="space-y-8">
                ...
                <div className="calculator-cta-section">
                  <h3 className="text-2xl font-bold mb-4">Protect vulnerable seniors from abuse</h3>
                  <p className="mb-6 max-w-2xl mx-auto">
                    Elder abuse and nursing home neglect deserve serious legal action. We'll investigate your case 
                    and hold facilities accountable for failing to protect your loved one. No fee unless we win.
                  </p>
