...
import { Calculator, ArrowLeft, Bomb } from 'lucide-react';
        ...
        <section className="py-20 bg-slate-50 border-t border-slate-200">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                <div className="text-4xl font-bold text-slate-900 mb-2">$900K+</div>
                <p className="text-slate-600">Gas explosion average</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-slate-900 mb-2">Multiple</div>
                <p className="text-slate-600">Injury types</p>
              </div>
              <div>
