    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          <ThreeDVisualEffects>
            <Card className="mb-8 premium-form-container interactive-card">
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Scale className="w-6 h-6 mr-3 text-blue-600" />
                  <span className="text-blue-600 font-display">Civil Rights Case Evaluation Form</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <form onSubmit={(e) => { e.preventDefault(); console.log('Civil Rights form submitted:', formData); alert('Thank you for your submission. We will contact you within 24 hours.'); }} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full btn-enhanced text-lg py-4">
