...
import californiaEnvironmentalResourcesRevisedImage from '@/assets/california-environmental-resources-revised.jpg';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2" ref={contentRef}>
            ...
            <section id="resources" className="content-section mb-12">
              <img 
                src={californiaEnvironmentalResourcesRevisedImage} 
                alt="California environmental protection agencies and contamination monitoring resources" 
                className="w-full h-64 object-cover rounded-lg mb-6"
              />
