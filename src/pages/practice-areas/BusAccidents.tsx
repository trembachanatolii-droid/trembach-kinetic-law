    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gray-900 text-white py-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-xl mb-12 leading-relaxed text-white">California law gives you only 6 months to file claims against government entities. Contact us today for your free consultation.</p>
