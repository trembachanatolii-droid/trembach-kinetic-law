            ...
            {step === 3 && results && (
              <div className="space-y-8">
                ...
                <div className="calculator-cta-section">
                  <h3 className="text-2xl font-bold mb-4">Speak with a compassionate attorney</h3>
                  <p className="mb-6 max-w-2xl mx-auto">
                    Wrongful death cases require sensitivity and expertise. We'll fight for full compensation 
                    to help your family during this difficult time. No fee unless we win.
                  </p>
