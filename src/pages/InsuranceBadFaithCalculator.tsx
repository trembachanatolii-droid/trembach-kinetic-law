            ...
            {step === 3 && results && (
              <div className="space-y-8">
                ...
                <div className="calculator-cta-section">
                  <h3 className="text-2xl font-bold mb-4">Hold insurance companies accountable</h3>
                  <p className="mb-6 max-w-2xl mx-auto">
                    Insurance companies have a duty to act in good faith. If they've wrongfully denied or delayed your claim, 
                    we'll fight for the compensation you're owed plus damages. No fee unless we win.
                  </p>
