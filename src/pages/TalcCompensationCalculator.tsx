        ...
        <section className="pt-20 pb-12 bg-gradient-to-b from-slate-50 to-white">
          <div className="container mx-auto px-6 max-w-5xl text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-black mb-6 tracking-tight leading-[1.1]">
              Talc Cancer<br />Calculator
            </h1>
            <p className="text-xl md:text-2xl text-slate-600 font-light">
              Baby powder cancer compensation
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-slate-600">Total verdict value</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-slate-900 mb-2">Proven</div>
                <p className="text-slate-600">Talc-cancer link</p>
              </div>
              <div>
