...
const EnvironmentalToxicCompensationCalculator = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Environmental Toxic Calculator | Chemical Exposure Compensation | Trembach Law</title>
        <meta name="description" content="Calculate environmental toxic exposure compensation for PFAS and chemical contamination. Free health impact estimates." />
      </Helmet>
        ...
        <section className="pt-20 pb-12 bg-gradient-to-b from-slate-50 to-white">
          <div className="container mx-auto px-6 max-w-5xl text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-black mb-6 tracking-tight leading-[1.1]">
              Environmental Toxic<br />Calculator
            </h1>
            <p className="text-xl md:text-2xl text-slate-600 font-light">
              Chemical exposure compensation
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-slate-600">PFAS settlement average</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-slate-900 mb-2">Property</div>
                <p className="text-slate-600">Damage coverage</p>
              </div>
              <div>
