          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-1">
              <Card className="p-6 sticky top-6">
                ...
                <ThreeDVisualEffects>
                  <div className="premium-form-container premium-form-container--blue-solid interactive-card glass-card rounded-2xl p-6 gpu-accelerated">
                    <div className="text-center mb-6">
                      <h3 className="text-2xl md:text-3xl font-display text-foreground font-bold mb-2">Get Your Free Motorcycle Accident Case Evaluation</h3>
