...
const ThreeStepProcess = () => {
  return (
    <section className="relative z-20 pt-32 pb-24 mt-24 bg-[#e8f0f7] border-t-2 border-border">
      <div className="container mx-auto px-8">
        ...
        <p className="text-title text-[#6b7280] text-center max-w-3xl mx-auto mb-20">
          ...
          <span style={{ color: '#FF4433', fontWeight: 700 }}>100% FREE TO START - NO FEES UNLESS WE WIN</span>
        </p>
        
        <div className="grid md:grid-cols-3 gap-16 mt-20">
          {/* Step 1 */}
          <div className="text-center">
            <div className="text-[120px] font-black mb-8 leading-none" style={{ color: '#0088FF', fontWeight: 900 }}>
              1
            </div>
            <h3 className="text-subtitle font-display font-semibold text-foreground mb-5">
              Contact Our California Attorneys{' '}
              <span className="inline-block bg-[#ff4444] text-white px-3 py-1 rounded text-sm font-extrabold uppercase tracking-wider">
                FREE
              </span>
            </h3>
            <p className="text-body text-[#6b7280] mb-8 leading-relaxed">
              Start with a <span style={{ color: '#FF4433', fontWeight: 700 }}>FREE</span>, confidential consultation available 24/7. We'll listen to your story, 
          ...
          <div className="text-center">
            ...
            <p className="text-body text-[#6b7280] mb-8 leading-relaxed">
              ...
              and if necessary, trial. All at <span style={{ color: '#FF4433', fontWeight: 700 }}>ZERO COST</span> to you upfront.
            </p>
            <ul className="space-y-3 text-left max-w-xs mx-auto">
              <li className="flex items-start gap-3 text-[#6b7280] text-small">
                <svg className="w-4 h-4 text-[#22c55e] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24">
          ...
          <div className="text-center">
            ...
            <p className="text-body text-[#6b7280] mb-8 leading-relaxed">
              We fight for maximum compensation under California law. You pay <span style={{ color: '#FF4433', fontWeight: 700 }}>NOTHING</span> unless we win. 
