...
import { Phone, Mail, MessageCircle, Star, ChevronDown, ChevronUp, Heart, Shield, Scale, Clock, Users, Award, FileText, AlertTriangle, Stethoscope, Building, Map, ArrowLeft, HardHat, Settings, Wrench } from 'lucide-react';
...
const ScaffoldingFalls: React.FC = () => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (goBackRef.current) {
        ...
        ScrollTrigger.create({
          ...
          onEnter: () => gsap.to(goBackRef.current, {
            opacity: 1,
            duration: 0.3
          }),
          onLeaveBack: () => gsap.to(goBackRef.current, {
            opacity: 0,
            duration: 0.3
          })
        });
  ...
  return <div className="min-h-screen bg-background">
      ...
      backgroundImage: `url(${heroBackground})`
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-6">
          <div className="hero-content">
            ...
            <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white font-bold px-8 py-4 text-lg" onClick={() => window.location.href = '/practice-areas/scaffolding-falls/case-evaluation'}>
      ...
      <Button ref={goBackRef} variant="ghost" onClick={handleGoBack} className="fixed top-24 left-6 z-50 flex items-center gap-2 bg-black/30 text-foreground hover:bg-black/50 backdrop-blur-sm">
          ...
          <div className="lg:col-span-2" ref={contentRef}>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select value={formData.accidentType} onValueChange={value => setFormData(prev => ({
                      ...prev,
                      accidentType: value
                    }))}>
                        <SelectTrigger>
            ...
            <section id="faq" className="content-section mb-12">
              ...
              <div className="space-y-4">
                {faqData.slice(0, 10).map((faq, index) => <Card key={index} className="border">
              ...
              <Collapsible open={expandedSections.moreFaqs} onOpenChange={() => toggleSection('moreFaqs')}>
                ...
                <CollapsibleContent className="space-y-4 mt-4">
                  {faqData.slice(10).map((faq, index) => <Card key={index + 10} className="border">
                      <CardHeader className="cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => setExpandedFaq(expandedFaq === index + 10 ? null : index + 10)}>
                        <CardTitle className="flex justify-between items-center text-base">
                          {faq.question}
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <Card className="bg-muted/50">
                ...
                <CardContent className="space-y-4">
                  <Button className="w-full bg-red-600 hover:bg-red-700 text-white h-12" onClick={() => window.location.href = 'tel:8181234567'}>
                    <Phone className="w-5 h-5 mr-2" />
                    Call (818) 123-4567
                  </Button>
                  
                  <Button variant="outline" className="w-full h-12" onClick={() => window.location.href = '/practice-areas/scaffolding-falls/case-evaluation'}>
                    <MessageCircle className="w-5 h-5 mr-2" />
                    Free Case Evaluation
                  </Button>
                  
                  <Button variant="outline" className="w-full h-12" onClick={() => window.location.href = 'mailto:info@trembachlawfirm.com'}>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <Button variant="link" className="p-0 h-auto text-left justify-start w-full text-primary hover:!text-primary" onClick={() => window.location.href = '/practice-areas/scaffolding-falls/compensation-calculator'}>
                    Compensation Calculator
                  </Button>
                  <Button variant="link" className="p-0 h-auto text-left justify-start w-full text-primary hover:!text-primary" onClick={() => window.location.href = '/practice-areas/scaffolding-falls/legal-guidance'}>
                    Legal Guidance
                  </Button>
                  <Button variant="link" className="p-0 h-auto text-left justify-start w-full text-primary hover:!text-primary" onClick={() => window.location.href = '/practice-areas/scaffolding-falls/case-evaluation'}>
                    Case Evaluation
                  </Button>
                </CardContent>
              </Card>
