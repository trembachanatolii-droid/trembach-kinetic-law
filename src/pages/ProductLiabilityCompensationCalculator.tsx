  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Calculate product liability compensation for defective products. Free estimates for medical devices and consumer goods." />
      </Helmet>
          ...
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-slate-600">Medical device average</p>
              </div>
              <div>
