...
import { Phone, Mail, MessageCircle, Star, ChevronDown, ChevronUp, Heart, Shield, Scale, Clock, Users, Award, FileText, AlertTriangle, Stethoscope, Building, Map, ArrowLeft, DollarSign, Home, Gavel } from 'lucide-react';
...
const GoBack: React.FC<GoBackProps> = ({
  ...
  return <div className={`fixed top-20 left-6 z-50 transition-opacity duration-300 ${isVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
      <Button variant="ghost" onClick={handleClick} className="flex items-center gap-2 bg-black/30 text-white hover:bg-black/50 backdrop-blur-sm">
...
const ElderAbuse: React.FC = () => {
  ...
  const tabs: TabSection[] = [{
    ...
    id: 'immediate-steps',
    label: 'WHAT TO DO AFTER ABUSE',
    icon: Heart
  }, {
    id: 'types-abuse',
    label: 'TYPES OF ELDER ABUSE',
    icon: AlertTriangle
  }, {
    id: 'legal-process',
    label: 'LEGAL PROCESS',
      ...
      backgroundImage: `url(${heroBackground})`
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-6">
          <div className="hero-content">
            ...
            <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white font-bold px-8 py-4 text-lg" onClick={() => window.location.href = '/elder-abuse-case-evaluation'}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 relative z-10" ref={contentRef}>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input type="text" value={formData.firstName} onChange={e => setFormData(prev => ({
                      ...prev,
            ...
            <section id="immediate-steps" className="content-section mb-12">
              ...
              <div className="mb-6">
                <img src={medicalCareImage} alt="Professional medical care documentation for elder abuse cases" className="w-full h-64 object-cover rounded-lg shadow-lg mb-4 hover:-translate-y-2 hover:shadow-xl transition-all duration-300 cursor-pointer group" />
            ...
            <section id="types-abuse" className="content-section mb-12">
              ...
              <div className="mb-6">
                <img src={financialProtectionImage} alt="Financial protection documentation for elder abuse prevention" className="w-full h-64 object-cover rounded-lg shadow-lg mb-4 hover:-translate-y-2 hover:shadow-xl transition-all duration-300 cursor-pointer group" />
            ...
            <section id="legal-process" className="content-section mb-12">
              ...
              <div className="mb-6">
                <img src={legalProcessImage} alt="Legal scales of justice representing elder abuse litigation" className="w-full h-64 object-cover rounded-lg shadow-lg mb-4 hover:-translate-y-2 hover:shadow-xl transition-all duration-300 cursor-pointer group" />
            ...
            <div className="sticky top-8">
              <Card className="mb-6">
                ...
                <CardContent className="space-y-4">
                  <img src={sidebarImage} alt="Professional elder abuse legal consultation" className="w-full h-40 object-cover rounded-lg mb-4" />
                  
                  <div className="space-y-4">
                    <Button className="w-full bg-red-600 hover:bg-red-700 text-white flex items-center justify-center gap-2" onClick={() => window.open('tel:8181234567')}>
                      <Phone className="w-4 h-4" />
                      Call (818) 123-4567
                    </Button>
                    
                    <Button variant="outline" className="w-full flex items-center justify-center gap-2 text-primary border-primary hover:bg-primary/10" onClick={() => window.location.href = '/elder-abuse-case-evaluation'}>
                      <MessageCircle className="w-4 h-4" />
                      Free Case Evaluation
                    </Button>
                    
                    <Button variant="outline" className="w-full flex items-center justify-center gap-2 text-primary border-primary hover:bg-primary/10" onClick={() => window.location.href = 'mailto:confidential@trembachlawfirm.com'}>
