...
import { Phone, Mail, MessageCircle, Star, ChevronDown, ChevronUp, Heart, Shield, Scale, Clock, Users, Award, FileText, AlertTriangle, Stethoscope, Building, Map, ArrowLeft, Camera, MapPin, Calendar, DollarSign, BookOpen, HelpCircle, Activity, Brain, Baby, Pill, UserX, CheckCircle, Calculator } from 'lucide-react';
...
const MedicalMalpractice: React.FC = () => {
  ...
  return <div className="min-h-screen bg-background">
      <SEO title="Medical Malpractice Attorney California | Free Case Evaluation | Expert Legal Help" description="California medical malpractice lawyers fighting for victims of medical negligence. Free case evaluation, contingency fees, maximum compensation. Call now for expert legal help." canonical="/practice-areas/medical-malpractice" />

      {/* Go Back Button */}
      <div className="fixed top-20 left-4 z-[100]">
        <Button variant="outline" size="sm" onClick={() => window.history.back()} className="flex items-center gap-2 bg-white/98 backdrop-blur-sm shadow-xl border border-gray-200 rounded-full px-3 py-1.5 text-xs font-medium hover:bg-white transition-all">
      ...
      <section className="relative min-h-[60vh] bg-cover bg-center bg-no-repeat flex items-center justify-center" style={{
      ...
      <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-sm border-b">
        <div className="container mx-auto px-8">
          <div className="flex overflow-x-auto scrollbar-hide py-4 gap-2">
            ...
            return <Button key={tab.id} variant={activeTab === tab.id ? "default" : "ghost"} onClick={() => scrollToSection(tab.id)} className="flex items-center gap-2 whitespace-nowrap">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-16">
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Input id="firstName" name="firstName" value={formData.firstName} onChange={handleInputChange} required className="border-red-200 focus:border-red-400" />
                      </div>
                      <div>
                        <label className="block text-sm font-medium mb-2" htmlFor="lastName">
                          Last Name *
                        </label>
                        <Input id="lastName" name="lastName" value={formData.lastName} onChange={handleInputChange} required className="border-red-200 focus:border-red-400" />
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Input id="email" name="email" type="email" value={formData.email} onChange={handleInputChange} required className="border-red-200 focus:border-red-400" />
                      </div>
                      <div>
                        <label className="block text-sm font-medium mb-2" htmlFor="phone">
                          Phone Number *
                        </label>
                        <Input id="phone" name="phone" type="tel" value={formData.phone} onChange={handleInputChange} required className="border-red-200 focus:border-red-400" />
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Input id="incidentDate" name="incidentDate" type="date" value={formData.incidentDate} onChange={handleInputChange} className="border-red-200 focus:border-red-400" />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <Input id="healthcareProvider" name="healthcareProvider" value={formData.healthcareProvider} onChange={handleInputChange} placeholder="Hospital, clinic, doctor's name" className="border-red-200 focus:border-red-400" />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea id="description" name="description" value={formData.description} onChange={handleInputChange} required rows={4} placeholder="Please provide details about the medical incident and any resulting injuries or complications..." className="border-red-200 focus:border-red-400" />
                    </div>

                    <div className="flex items-start space-x-3">
                      <input type="checkbox" id="consent" className="mt-1" checked={formData.consentToContact} onChange={e => setFormData(prev => ({
                      ...prev,
                    ...
                    <div className="text-center">
                      <Button type="submit" size="lg" className="bg-red-600 hover:bg-red-700 text-white px-12 py-4 text-lg font-semibold">
            ...
            <section id="what-to-do" className="content-section mb-16">
              ...
              <div className="mb-8">
                <img src={surgicalErrorsImage} alt="What to do after medical malpractice - immediate steps for victims" className="w-full h-64 object-cover rounded-lg shadow-lg" />
              </div>
            ...
            <section id="types-of-errors" className="content-section mb-16">
              ...
              <div className="mb-8">
                <img src={diagnosticErrorsImage} alt="Types of medical errors and malpractice cases handled by California attorneys" className="w-full h-64 object-cover rounded-lg shadow-lg" />
              </div>
            ...
            <section id="compensation" className="content-section mb-12">
              ...
              <div className="mb-8">
                <img src={compensationImage} alt="Understanding compensation types in medical malpractice cases - economic and non-economic damages" className="w-full h-64 object-cover rounded-lg shadow-lg" />
              </div>
      ...
      <section className="bg-gradient-to-r from-red-600 via-red-700 to-red-800 py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto">
            <Button className="bg-white text-red-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-lg text-lg transition-all duration-300 hover:scale-105" onClick={() => window.location.href = '/medical-malpractice-case-evaluation'}>
              Start Free Case Evaluation
            </Button>
            <Button className="border-2 border-white text-white bg-transparent hover:bg-white hover:text-red-600 font-bold py-4 px-8 rounded-lg text-lg transition-all duration-300 hover:scale-105" onClick={() => window.open('tel:8553742906')}>
              Call (855) 374-2906
            </Button>
          </div>
        </div>
