...
import { Calculator, ArrowLeft, Activity } from 'lucide-react';

const ParalysisCompensationCalculator = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Paralysis Calculator | Paraplegic Injury Compensation | Trembach Law</title>
        <meta name="description" content="Calculate paralysis compensation for quadriplegia and paraplegia. Free caregiver cost estimates." />
      </Helmet>
        ...
        <section className="pt-20 pb-12 bg-gradient-to-b from-slate-50 to-white">
          <div className="container mx-auto px-6 max-w-5xl text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-black mb-6 tracking-tight leading-[1.1]">
              Paralysis<br />Calculator
            </h1>
            <p className="text-xl md:text-2xl text-slate-600 font-light">
              Paraplegic injury compensation
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                ...
                <p className="text-slate-600">Caregiver coverage</p>
              </div>
              <div>
